...
class StateRepo(BaseRepository):
    ...
    def pre_update(self, object: StateModel):
        self.sp_name = "sStateUpdate"
        list_params = [object.stateid,object.name,object.code]
        self.params_list = list_params
    ...
    def pre_delete(self, object: StateModel):
        self.sp_name = "sStateDelete"
        list_params = [object.stateid,object.name,object.code]
        self.params_list = list_params
    ...
    def post_get(self, cursor_object):
        if len(cursor_object.get_data()) > 0:
            ...
            for each_tuple in cursor_object.get_data():
                state_model.stateid = each_tuple[0]
                state_model.name = each_tuple[1]
                state_model.code = each_tuple[2]
    ...
    def pre_get_list_object(self, params: ParamsObject):
        self.sp_name = "sStateObjectGetList"
        self.params_list = params.get_params_list()
