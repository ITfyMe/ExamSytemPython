...
from examsystemapp.repository.college_branch_repository import CollegeBranchRepo
...
class CollegeBranchService(BaseService):
    ...
    def add_data(self, object):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.add_data(object)
    ...
    def update_data(self, object):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.update_data(object)
    ...
    def delete_data(self, object):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.delete_data(object)
    ...
    def get_data(self, params):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.get_data(params)
    ...
    def get_data_list(self, params):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        college_branch_repo: CollegeBranchRepo = CollegeBranchRepo()
        return college_branch_repo.get_data_list_object_any_paginated(sp_name, params)
