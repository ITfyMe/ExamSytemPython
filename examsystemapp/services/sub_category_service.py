...
from examsystemapp.repository.sub_category_repository import SubCategoryRepo
...
class SubCategoryService(BaseService):
    ...
    def add_data(self, object):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.add_data(object)
    ...
    def update_data(self, object):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.update_data(object)
    ...
    def delete_data(self, object):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.delete_data(object)
    ...
    def get_data(self, params):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.get_data(params)
    ...
    def get_data_list(self, params):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        sub_category_repo: SubCategoryRepo = SubCategoryRepo()
        return sub_category_repo.get_data_list_object_any_paginated(sp_name, params)
