...
from examsystemapp.repository.staff_repository import StaffRepo
...
class StaffService(BaseService):
    ...
    def add_data(self, object):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.add_data(object)
    ...
    def update_data(self, object):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.update_data(object)
    ...
    def delete_data(self, object):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.delete_data(object)
    ...
    def get_data(self, params):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.get_data(params)
    ...
    def get_data_list(self, params):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        staff_repo: StaffRepo = StaffRepo()
        return staff_repo.get_data_list_object_any_paginated(sp_name, params)
