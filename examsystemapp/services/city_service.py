...
from examsystemapp.repository.city_repository import CityRepo
...
class CityService(BaseService):
    ...
    def add_data(self, object):
        ...
        return city_repo.add_data(object)
    ...
    def update_data(self, object):
        city_repo: CityRepo = CityRepo()
        return city_repo.update_data(object)
    ...
    def delete_data(self, object):
        city_repo: CityRepo = CityRepo()
        return city_repo.delete_data(object)
    ...
    def get_data(self, params):
        city_repo: CityRepo = CityRepo()
        return city_repo.get_data(params)
    ...
    def get_data_list(self, params):
        city_repo: CityRepo = CityRepo()
        return city_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        city_repo: CityRepo = CityRepo()
        return city_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        city_repo: CityRepo = CityRepo()
        return city_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        city_repo: CityRepo = CityRepo()
        return city_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        city_repo: CityRepo = CityRepo()
        return city_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        city_repo: CityRepo = CityRepo()
        return city_repo.get_data_list_object_any_paginated(sp_name, params)
