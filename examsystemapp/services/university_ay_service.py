...
from examsystemapp.repository.university_ay_repository import UniversityAYRepo
...
class UniversityAYService(BaseService):
    ...
    def add_data(self, object):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.add_data(object)
    ...
    def update_data(self, object):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.update_data(object)
    ...
    def delete_data(self, object):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.delete_data(object)
    ...
    def get_data(self, params):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.get_data(params)
    ...
    def get_data_list(self, params):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        university_ay_repo: UniversityAYRepo = UniversityAYRepo()
        return university_ay_repo.get_data_list_object_any_paginated(sp_name, params)
