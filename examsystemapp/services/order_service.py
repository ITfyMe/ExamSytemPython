...
from examsystemapp.repository.order_repository import OrderRepo
...
class OrderService(BaseService):
    ...
    def add_data(self, object):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.add_data(object)
    ...
    def update_data(self, object):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.update_data(object)
    ...
    def delete_data(self, object):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.delete_data(object)
    ...
    def get_data(self, params):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.get_data(params)
    ...
    def get_data_list(self, params):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        order_repo: OrderRepo = OrderRepo()
        return order_repo.get_data_list_object_any_paginated(sp_name, params)
