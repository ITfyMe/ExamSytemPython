...
from examsystemapp.repository.category_repository import CategoryRepo
...
class CategoryService(BaseService):
    ...
    def add_data(self, object):
        ...
        return category_repo.add_data(object)
    ...
    def update_data(self, object):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.update_data(object)
    ...
    def delete_data(self, object):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.delete_data(object)
    ...
    def get_data(self, params):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_data(params)
    ...
    def get_data_list(self, params):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_data_list_object_any_paginated(sp_name, params)

    def get_menu(self):
        category_repo: CategoryRepo = CategoryRepo()
        return category_repo.get_menu()
