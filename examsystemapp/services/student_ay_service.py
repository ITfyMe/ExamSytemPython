...
from examsystemapp.repository.student_ay_repository import StudentAYRepo
...
class StudentAYService(BaseService):
    ...
    def add_data(self, object):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.add_data(object)
    ...
    def update_data(self, object):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.update_data(object)
    ...
    def delete_data(self, object):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.delete_data(object)
    ...
    def get_data(self, params):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.get_data(params)
    ...
    def get_data_list(self, params):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        student_ay_repo: StudentAYRepo = StudentAYRepo()
        return student_ay_repo.get_data_list_object_any_paginated(sp_name, params)
