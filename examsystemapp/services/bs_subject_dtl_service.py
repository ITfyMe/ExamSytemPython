...
from examsystemapp.repository.bs_subject_dtl_repository import BSSubjectDtlRepo
...
class BSSubjectDtlService(BaseService):
    ...
    def add_data(self, object):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.add_data(object)
    ...
    def update_data(self, object):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.update_data(object)
    ...
    def delete_data(self, object):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.delete_data(object)
    ...
    def get_data(self, params):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.get_data(params)
    ...
    def get_data_list(self, params):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.get_data_list(params)
    ...
    def get_data_object(self, params):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.get_data_object(params)
    ...
    def get_data_list_object(self, params):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.get_data_list_object(params)
    ...
    def get_data_list_object_paginated(self, params):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.get_data_list_object_paginated(params)
    ...
    def get_data_list_object_any(self, sp_name, params: ParamsObject):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.get_data_list_object_any(sp_name, params)

    def get_data_list_object_any_paginated(self, sp_name, params: ParamsObject):
        bs_subject_dtl_repo: BSSubjectDtlRepo = BSSubjectDtlRepo()
        return bs_subject_dtl_repo.get_data_list_object_any_paginated(sp_name, params)
