...
class CollegeModel(BaseModel):
    def __init__(self, collegeid=None,universityid=None,name=None,code=None,addr1=None,addr2=None,addr3=None,cityid=None,stateid=None,pincode=None,phone=None,email=None,logo=None,url=None):
